...
speak("Loading Friday version 2 point o")
...
# # =======
# >>>>>>> ce1a6ada7571290502ea1db6550e6c5410dd29e0

notification.notify(
        title="Friday 2.0",
        message="Friday 2.0 initialized. Ready to go !",
        timeout=10,
...
def wishMe():
	...
	assname =("Friday version 2 pont o")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'quit' in a or 'close' in a or 'exit' in a or 'quit friday' in a or 'close friday' in a or 'exit friday' in a or 'bye' in a or 'bye friday' in a:
            ...
            speak("My name is friday - The virtual assistant cum chatbot. I was created by Mr. Gokul and Karthy for NLP project.")
        ...
        elif 'open gpt' in a or 'show gpt' in a:
            speak("Opening google")
